...
namespace CoreValidatorExample.DataAccessLayer.Migrations
{
    ...
    partial class CoreLoanValidatorExampleDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("CoreValidatorExample.DataAccessLayer.Data.Appraisal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProposalId = 1,
                            Status = 1,
                            SubmissionDate = new DateTime(2024, 11, 23, 17, 54, 12, 724, DateTimeKind.Local).AddTicks(3380)
                        },
                        new
                        {
                            AppraisalId = 2,
                            ...
                            ProposalId = 2,
                            Status = 2,
                            SubmissionDate = new DateTime(2024, 11, 23, 17, 54, 12, 724, DateTimeKind.Local).AddTicks(6840)
                        });
                });
            ...
            modelBuilder.Entity("CoreValidatorExample.DataAccessLayer.Data.Decision", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DecisionId = 1,
                            DecisionDate = new DateTime(2024, 11, 23, 17, 54, 12, 724, DateTimeKind.Local).AddTicks(9991),
                            Outcome = 2,
                            ProposalId = 1,
                            Reason = "Reason 1"
                        },
                        ...
                        {
                            DecisionId = 2,
                            DecisionDate = new DateTime(2024, 11, 23, 17, 54, 12, 725, DateTimeKind.Local).AddTicks(904),
                            Outcome = 3,
                            ProposalId = 2,
                            Reason = "Reason 2"
                        });
            ...
            modelBuilder.Entity("CoreValidatorExample.DataAccessLayer.Data.Proposal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = 1,
                            SubmissionDate = new DateTime(2024, 11, 23, 17, 54, 12, 718, DateTimeKind.Local).AddTicks(8310),
                            Title = "Proposal 1"
                        },
                        new
                        {
                            ...
                            Status = 2,
                            SubmissionDate = new DateTime(2024, 11, 23, 17, 54, 12, 724, DateTimeKind.Local).AddTicks(885),
                            Title = "Proposal 2"
                        });
                });
