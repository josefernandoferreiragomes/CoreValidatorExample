...
namespace CoreValidatorExample.DataAccessLayer.Migrations
{
    ...
    [Migration("20241123174004_InitialCreate")]
            ...
            modelBuilder.Entity("CoreValidatorExample.DataAccessLayer.Data.Appraisal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProposalId = 1,
                            Status = 1,
                            SubmissionDate = new DateTime(2024, 11, 23, 17, 40, 3, 534, DateTimeKind.Local).AddTicks(641)
                        },
                        new
                        {
                            AppraisalId = 2,
                            ...
                            ProposalId = 2,
                            Status = 2,
                            SubmissionDate = new DateTime(2024, 11, 23, 17, 40, 3, 534, DateTimeKind.Local).AddTicks(2014)
                        });
                });
            ...
            modelBuilder.Entity("CoreValidatorExample.DataAccessLayer.Data.Decision", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DecisionId = 1,
                            DecisionDate = new DateTime(2024, 11, 23, 17, 40, 3, 534, DateTimeKind.Local).AddTicks(3756),
                            Outcome = 2,
                            ProposalId = 1,
                            Reason = "Reason 1"
                        },
                        ...
                        {
                            DecisionId = 2,
                            DecisionDate = new DateTime(2024, 11, 23, 17, 40, 3, 534, DateTimeKind.Local).AddTicks(4271),
                            Outcome = 3,
                            ProposalId = 2,
                            Reason = "Reason 2"
                        });
            ...
            modelBuilder.Entity("CoreValidatorExample.DataAccessLayer.Data.Proposal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = 1,
                            SubmissionDate = new DateTime(2024, 11, 23, 17, 40, 3, 528, DateTimeKind.Local).AddTicks(81),
                            Title = "Proposal 1"
                        },
                        new
                        {
                            ...
                            Status = 2,
                            SubmissionDate = new DateTime(2024, 11, 23, 17, 40, 3, 533, DateTimeKind.Local).AddTicks(8657),
                            Title = "Proposal 2"
                        });
                });
